...
import { paginate, verifyAdmin, verifyUser, verifyToken, } from "../middlewares/index.js";
...
router.get("/not-private", verifyToken, paginate(User), UserController.getNotPrivateUsers);
